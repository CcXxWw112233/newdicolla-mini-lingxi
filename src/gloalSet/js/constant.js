export const BASE_URL = 'http://dzz4dp.natappfree.cc'//'https://lingxi.di-an.com'//'http://w4iawu.natappfree.cc'//'http://test.lingxi.new-di.com'//'http://192.168.1.68'//'http://prerelease.lingxi.new-di.com'
