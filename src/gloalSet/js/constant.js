export const BASE_URL = 'http://kxwhba.natappfree.cc'//'https://lingxi.di-an.com'//' 'http://test.lingxi.new-di.com'//'http://192.168.1.68'//'http://prerelease.lingxi.new-di.com'
