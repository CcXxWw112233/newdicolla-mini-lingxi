export const BASE_URL = 'http://test.lingxi.new-di.com'//'http://test.lingxi.new-di.com'//'http://am5evc.natappfree.cc'//'http://192.168.1.68'//'http://prerelease.lingxi.new-di.com'
